// Pure helpers for the weather widget, ported from omarchy's
// shell/plugins/panels/weather/Model.js. No quickshell state here - every
// function maps data in, data out, which keeps the data plumbing in
...
// weather.json may only carry a name), empty for IP auto-detect.
...
// Resolve a commit from the search field: the selected geocoded suggestion if
// one exists, otherwise the raw typed name (coordinates unknown).
...
// wttr.in weather code → Nerd Font glyph. Codepoints match omarchy's
// weather panel verbatim so the glyphs render identically.
